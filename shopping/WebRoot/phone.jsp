...
//默认显示第一页
ArrayList al=gbb.getGoodsByPage(6,pageNow,lei);


int pageCount=gbb.getPageCount(6,lei);
%>
  ...
  <body>
    ...
    <div class="cart-top">
        ...
        <div>
            ...
            <input type="text" name="sousuo" placeholder="夏季必备"><input type="submit" class="searchbutton" value="搜索">
            </form>
        </div>
    </div>
    ...
    <div class="index-sale">
      ...
      <tr>
        ...
        <tr>
        <td><a href="ProductServlet?GoodsId=<%=gb.getGoodsId() %>&lei=<%=lei %>"><input type="button" name="tianjia" value="添加"></a></td>
        </tr>
    </table></td>
  					<%
  				}
  ...
  <tr>
    ...
    <%
    	for(int i=1;i<=pageCount;i++){
    		...
    		%>
    		<a href="GoodsServlet?pageNow=<%=i %>&lei=<%=lei %>">【<%=i %>】</a>
    		<%
    	}
